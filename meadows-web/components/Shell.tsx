  ...
  return (
    <div className={`min-h-screen flex flex-col ${isAr ? 'font-arabic' : ''}`}>
      ...
      <a
        ...
        className="fixed bottom-5 end-5 z-40 w-14 h-14 rounded-full bg-whatsapp text-white grid place-items-center shadow-lift hover:scale-105 transition-transform"
      >
