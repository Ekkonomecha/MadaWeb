  ...
  return (
    <div className={`min-h-screen flex flex-col ${isAr ? 'font-arabic' : ''}`}>
      ...
      <a
        ...
        aria-label={t(footer.whatsappLabel, lang)}
        className="fixed bottom-5 end-5 z-40 w-14 h-14 rounded-full bg-whatsapp text-white grid place-items-center transition-transform duration-300 hover:scale-105"
      >
